...
const Footer = () => {
  return (
    <footer className="custom-footer pt-4 pt-md-5">
      <div className="footer-main container d-flex flex-wrap justify-content-between align-items-start gap-4 gap-md-5 pb-4">
        {/* Left Help Box */}
        ...
        {/* Right Links */}
        <div className="footer-links d-flex flex-wrap gap-3 gap-md-5 justify-content-md-end">
      ...
      {/* Bottom Bar */}
      <div className="footer-bottom-bar d-flex justify-content-between align-items-center px-3 px-md-4">
