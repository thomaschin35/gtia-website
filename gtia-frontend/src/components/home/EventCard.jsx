...
const EventCard = ({
  ...
  return (
    <Link
      to={href}
      className={cn(
        "flex w-[min(400px,100%)] shrink-0 flex-col overflow-hidden rounded-[16px] border border-solid border-line bg-white no-underline transition-shadow hover:shadow-[0_8px_24px_rgba(1,50,75,0.1)]",
        className
      )}
    >
